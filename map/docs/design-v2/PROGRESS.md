...
| **P4 시그널** | ⏳ **다음** | 감지 룰 서버·피드 화면·근거 펼침·페르소나 골드(틀) |
| P5 경제 | — | 지갑 서버 연동(비용 2/3 개정·적중 환급 실지급)·XP/레벨/캐릭터 |
...
- **다음 착수점: P4 시그널** — 감지 룰(엔진 지표 기반: 거래량 배수·변동성 확대·밴드 이탈·갭·신고가), 서버 피드(보관 3일·20+10·읽음), sig 화면(요약 4장·피드 펼침=근거 콘텐츠·분석 CTA), 홈 히어로 시그널 카드 연결. 치환표 R-D01~03 참조.
