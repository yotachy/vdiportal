...
| **P6 페르소나** | ⏳ **다음** | 질문 은행(총량 비공개)·일 5답·정밀도 단계·레이더·커스텀 보정 연결 |
| P7 통계 / P8 계정 / P9 마감 / P10 앱 셸 | — | BUILD-PLAN §7 |
...
- **다음 착수점: P6 페르소나** — 질문 은행(서버, 출시 300문+ 목표·초기 콘텐츠는 협의, **총량 비공개**), 홈 카드 즉시 질문·풀 배급(하루 첫 답 자동·이후 '하나 더 받기')·일 5답·이전 답 고치기, 정밀도 단계(0/4/9/16/31/61)·16축 레이더·히트맵, 커스텀 pfit 실보정 연결(보정 알고리즘은 엔진 몫 — 협의), 게스트 3문 잠금, 프리셋 '내 성향' 카드 활성. 해부 03 §6 참조.
