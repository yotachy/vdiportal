...
(function () {
  ...
  MS.router.register("landing", {
    mount: function (host) {
      ...
      host.innerHTML =
        ...
        landingCard('<svg viewBox="0 0 24 24" width="15" height="15" style="display:block;flex:none" aria-hidden="true"><rect x="3" y="13" width="4" height="8" rx="1.2" fill="var(--logo-a)"></rect><rect x="10" y="9" width="4" height="12" rx="1.2" fill="var(--logo-b)"></rect><rect x="17" y="4" width="4" height="17" rx="1.2" fill="var(--logo-c)"></rect></svg>', "3단계 분석", "지표 " + MS.engine.indicatorCount() + "종, 가중치와<br>페르소나까지 커스텀") +
  ...
  MS.router.register("ob3", obScreen(3, "ob4", "", "3 / 7 · 분석",
    (function () { return MS.engine.basicSet().length + "개로 시작해서,<br>" + MS.engine.indicatorCount() + "개로 깊게 봅니다"; })(),
