  ...
  (function initZoom() {
    ...
    function _fsRefit() { try { if (typeof fitPrediction === "function") fitPrediction(); else if (typeof redrawCharts === "function") redrawCharts(); } catch (e) { if (typeof redrawCharts === "function") redrawCharts(); } }
  ...
  async function loadTicker() {
    ...
    try {
      ...
      if (r && r.ok && Array.isArray(r.candles) && r.candles.length >= 2) {
        applyTickerOHLC(t, r); autoLogForTicker(t); runForge(); renderTickerPanel();
  ...
  async function runEngine() {
    ...
    runForge(); _engineDirty = false; updateEngineBtn();                       // 실제 계산(오버레이 뒤)
  ...
  const THEMES = {
    ...
    teal:     { name: "딥틸 (청록)", group: "dark", c: "#0b1517", g: "#5ec8b6", vars: { "--bg": "#0b1517", "--panel": "#101f21", "--surface": "#13262a", "--raised": "#182d31", "--raised2": "#233d42", "--line": "#1a2e30", "--edge": "#3d5a5c", "--ink": "#e6f0ee", "--eth": "#8aa5a2", "--muted": "#8ba6a3", "--faint": "#6a827f", "--gold": "#5ec8b6", "--gold-dim": "#2e5a52", "--bull": "#46c28e", "--bear": "#e06a6a", "--hover": "rgba(255,255,255,.05)", "--scrim": "rgba(11,21,23,.72)", "--grid": "#173033", "--chart-bg": "#0b1517" } },
    ...
    orange:   { name: "앰버 오렌지", group: "dark", c: "#14100b", g: "#e8955c", vars: { "--bg": "#14100b", "--panel": "#1d160e", "--surface": "#221a11", "--raised": "#291e13", "--raised2": "#3a2c1b", "--line": "#2b2015", "--edge": "#5a4a30", "--ink": "#f5ece0", "--eth": "#b29a8a", "--muted": "#a6938b", "--faint": "#847668", "--gold": "#e8955c", "--gold-dim": "#5e412c", "--bull": "#46c28e", "--bear": "#e06a6a", "--hover": "rgba(255,255,255,.05)", "--scrim": "rgba(20,16,11,.72)", "--grid": "#2b2015", "--chart-bg": "#14100b" } },
  ...
  function playAnalysis() {
    ...
    let steps;
    try { steps = ForgeCore.runSteps(boardToGraph(), currentData(), { futW: visionFutW(), visionBias: visionBiasLive(), timeframe: activeTF(), driftWeights: _driftW }); }
  ...
  function runForge() {
    ...
    try {
      ...
      lastResult = ForgeCore.run(g, d, { futW: visionFutW(), visionBias: visionBiasLive(), timeframe: activeTF(), driftWeights: _driftW });
  ...
  document.addEventListener("DOMContentLoaded", () => {
    boardInit();
    { const _pp = document.getElementById("paramPanel"), _bp = document.getElementById("boardPane"); if (_pp && _bp && _pp.parentElement !== _bp) _bp.appendChild(_pp); }   // 편집기를 가운데 패널로 이동
