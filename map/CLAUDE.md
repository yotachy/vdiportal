...
- **단독 문서 페이지**(의존 없음 · 개별 배포 가능): `forge-guide.html`(작동원리) · `forge-scorecard.html`(검증 성적) · **`app-spec.html`(앱 화면 요건정의 — 2026-08-19 신설)**. 위 8종 세트와 달리 동반 업로드 제약이 없다. 배포 `www/map/`, URL `https://parksvc.mycafe24.com/map/app-spec.html`.
