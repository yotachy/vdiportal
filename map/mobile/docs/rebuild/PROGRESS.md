...
| P1a 재방문 · 무료 | 8 / 8 | ✅ |
| P4 첫 실행 · 온보딩 | 8 / 8 | ✅ |
| **P1b 재방문 · 유료** | **6 / 10** | 🔨 진행 중 — **G1 잠금 해제 완료(최소 출하 지점 도달)** |
...
| **G1 잠금 해제** | 2·3·4·5·6 ✅ | **심화·전문이 열렸다 — 최소 출하 지점 도달**. tierBuyable('full')·tierBuyable('custom') 둘 다 true, 지갑 spend 경로(full 3스쿱)가 처음 실사용됐다(브라우저 관문 report-purchase 실증). T2 실측: 과열 23.5%(볼린저 상단 or RSI 과매수) · 저항 20.7%(엔진 `ma.sr` 재사용) · 동시 1.3% |
