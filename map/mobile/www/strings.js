...
(function (root, factory) {
  ...
  var t = {
    ...
    // 아래 셋은 7단계(옛 내용, Task 8 이 다시 짤 몫이라 아직 손 안 댐)의 bandRow(폭)·
    // 비교표(기본분석/심화분석 라벨)가 계속 쓴다. obTutOf(옛 tutHead "N / 3")는 Task 7 이
    // 6단계를 실제 분석으로 갈아치우며 그 호출자와 함께 지웠다 — 죽은 문구를 남기지 않는다.
    obTutWidth: "폭 ",
    obTut2Basic: "기본분석", obTut2Full: "심화분석",
