...
> ⚠️ **2026-08-19 — 이 문서 위에 [`DESIGN-BRIEF-2026-08-19.md`](DESIGN-BRIEF-2026-08-19.md) 가 있다.**
> 이 문서(1차)는 "지금 있는 기능을 시안으로 옮기기 위한 분해도"였다. 1차 시안대로 구현해 본 뒤
> 드러난 문제(동기 설계 부재)와 그 결과 확정된 제품 결정 — 경제 수치·무료/유료 경계·기각된 안·
> 실측으로 반증된 전제 — 은 **2차 문서에 있다.** 2차 시안을 그릴 때는 그쪽을 먼저 읽을 것.
