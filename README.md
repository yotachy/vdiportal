...
> 수행사가 **Bootstrap 5.3.8**로 구현할 때의 변환 기준은 [`BOOTSTRAP_GUIDE.md`](BOOTSTRAP_GUIDE.md)를 참조하세요.
...
```
vdiportal/
├── README.md / STYLE_GUIDE.md / BOOTSTRAP_GUIDE.md   ← 개요 · 소스 가이드 · Bootstrap 구현 가이드(수행사용)
